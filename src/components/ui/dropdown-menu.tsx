...
function Dropdown({ content, children, contentClassName }: { content: React.ReactNode, children: React.ReactNode, contentClassName?: string }) {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuPortal>
        <DropdownMenuContent align="end" className={cn("w-64 p-0 rounded-xl overflow-hidden border border-gray-200 dark:border-zinc-800 shadow-xl z-50", contentClassName)}>
          {content}
        </DropdownMenuContent>
      </DropdownMenuPortal>
    </DropdownMenu>
