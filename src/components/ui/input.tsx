  ...
  return (
    <div className="flex flex-col w-full">
      <InputPrimitive
        ...
        data-slot="input"
        className={cn(
          "h-8 w-full min-w-0 rounded-sm font-normal border border-gray-200 bg-white dark:bg-zinc-900 dark:border-slate-800 px-2.5 py-1 text-xs transition-all outline-none file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-xs file:font-medium file:text-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 dark:disabled:bg-input/80",
