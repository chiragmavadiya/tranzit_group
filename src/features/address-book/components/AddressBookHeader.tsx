  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div className='absolute top-0 left-0'>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">My Address Book</h1>
        <p className="text-gray-500 dark:text-zinc-400 mt-1">
          Manage your saved addresses, contact persons, and business details.
        </p>
      </div>
