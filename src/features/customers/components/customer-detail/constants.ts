...
export const MOCK_STATS = [
    { label: 'Total Order', value: '1', icon: Package, iconColor: 'text-primary', iconBg: 'bg-primary/10' },
    { label: 'Total Wallet Balance', value: '$63.70', icon: Wallet, iconColor: 'text-primary', iconBg: 'bg-primary/10' },
    { label: 'Total Pickup Charge', value: '$0.00', icon: MapPin, iconColor: 'text-primary', iconBg: 'bg-primary/10' },
