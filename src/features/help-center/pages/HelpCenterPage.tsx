...
import { helpCenterCategories } from '@/features/help-center/constants'
        ...
        return helpCenterCategories
            .map((category) => ({
                ...
                articles: category.articles.filter((article) => {
                    const haystack = `${article.title} ${article.subtitle} ${article.qas
                    ...
                    {filteredCategories.map((category) => (
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-slate-200/80 px-4 py-3">
                                <h2 className="text-[15px] font-semibold text-slate-700">{category.name}</h2>
