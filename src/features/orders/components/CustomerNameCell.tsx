        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger className="w-full">
            <button
              ...
              className="w-full px-1.5 py-1.5 border border-transparent group-hover/row:border-gray-200 group-hover/row:bg-white rounded-sm dark:hover:bg-zinc-900 flex items-center justify-between hover:text-primary transition-colors outline-none cursor-pointer text-slate-800 dark:text-zinc-200"
            >
