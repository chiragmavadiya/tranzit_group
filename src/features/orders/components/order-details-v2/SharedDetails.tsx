...
export const MetricCard = ({
    ...
    <Card className="group border-border/60 bg-white shadow-sm transition-all hover:shadow-md hover:border-blue-200/50">
        <CardContent className="flex items-start justify-between px-5 py-5">
            <div className="space-y-1">
                ...
                <p className="text-2xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{value}</p>
